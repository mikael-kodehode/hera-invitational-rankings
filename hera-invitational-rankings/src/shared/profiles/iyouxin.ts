export const iyouxinProfileInfo = `
  <p>
    ...
    <br/><br/>
    His aggressive style with high energy in World of Tanks might influence his AoE style of play.
  </p>
`

export const iyouxinTrivia = `
  <ul>
    <li>His first video on Youtube was about the Bat.-Châtillon 25 t AP. It weighs 25 tons.</li>
    <li>He lives in Germany.</li>
  </ul>
`

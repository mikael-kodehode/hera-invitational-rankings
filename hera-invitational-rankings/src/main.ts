import './style.css'
import { initiateListeners } from './interactions'
  ...
  <body class="w3-black">
    ...
    <div class="w3-padding-large" id="main">
      ...
      <nav class="" id="playerProfileNav">
        <li class="active-player" id="GrubbyButton">I</li>
        <li class="" id="second-p">II</li>
        <li class="" id="third-p">III</li>
      </nav>
      <article id="playerProfile" class="player-profile"></article>

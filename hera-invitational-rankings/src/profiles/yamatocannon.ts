export const yamatocannonProfileInfo = `
  <p>
Jakob "YamatoCannon" Mebdi is a prominent Swedish professional League of Legends coach, former player, and celebrated on-air analyst. Renowned for his distinct fashion sense, deep baritone voice, and charismatic leadership style, he built an extensive coaching legacy across major teams like Splyce, Team Vitality, Fnatic, and Karmine Corp. Today, he seamlessly balances his high-level coaching ventures with full-time content creation, acting as a highly influential voice and personality within the global League of Legends community. </p>
`

export const yamatocannonTrivia = `
  <ul>
